...
function defaultTwoofTwo(){
    ...
    d3.json(searchLink, function(data){
        ...
        olympianPieSmall('olympians-pie2', 'Summer', summerNonmedals, summerGolds, summerSilvers, summerBronzes);
        olympianPieSmall('olympians-pie3', 'Winter', winterNonmedals, winterGolds, winterSilvers, winterBronzes);
